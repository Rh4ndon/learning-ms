...
<nav class="navbar navbar-expand-lg navbar-light pe-theme-navbar shadow-sm">
    <div class="container-fluid">
        <!--button type="button" id="openSidebar" class="btn pe-theme-btn">
        ...
        <div class="ms-auto d-flex align-items-center">
            ...
            <div class="dropdown">
                <button class="btn pe-theme-btn-outline dropdown-toggle" type="button" id="userDropdown" data-bs-toggle="dropdown">
