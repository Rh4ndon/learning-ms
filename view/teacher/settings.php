                        ...
                        <form action="../../controllers/update-user.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pe-theme-input" name="first_name" id="first_name" placeholder="Enter your First Name" required value="<?php echo $_SESSION['first_name']; ?>">
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text pe-theme-input"><i class="fas fa-user"></i></span>
                                    <input type="text" class="form-control pe-theme-input" name="last_name" id="last_name" placeholder="Enter your Last Name" required value="<?php echo $_SESSION['last_name']; ?>">
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Enter your current password or a new password to update.</div>
                            </div>
